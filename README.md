...
[![version](https://img.shields.io/badge/version-v0.6.2-7257e8)](https://github.com/Githun1314/lingxi-skin-manager/releases/latest)
...
管理器不会修改 `/Applications/WPS 灵犀.app`。它只连接本机 `127.0.0.1` 调试端口，向灵犀当前页面注入由管理器生成的受控主题样式和品牌信息。
...
打开 `http://127.0.0.1:17363`。构建 macOS 分享包：
