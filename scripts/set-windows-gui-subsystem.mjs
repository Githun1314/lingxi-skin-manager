...
if (!executablePath) {
  throw new Error("Usage: node set-windows-gui-subsystem.mjs <application.exe>");
}
...
// IMAGE_SUBSYSTEM_WINDOWS_GUI = 2. This suppresses the persistent command
// window when users double-click the already-tested executable.
